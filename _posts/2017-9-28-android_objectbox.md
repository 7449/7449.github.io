...
## 介绍
 ...
 ![_config.yml]({{ site.baseurl }}/assets/screenshot/17/objectbox-sqlite.png)
...
之前也写过`greenDao`相关的Blog，有兴趣的可以看看：[Android_greenDaoCRUD](https://7449.github.io/2016/10/08/android_greendao_CRUD.html)
