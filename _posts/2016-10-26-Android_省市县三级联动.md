...
通过解析xml文件实现android上面的省市县三级联动。

代码示例：[https://github.com/7449/AndroidDevelop/tree/master/WheelViewSimple](https://github.com/7449/AndroidDevelop/tree/master/WheelViewSimple)

效果图：

![_config.yml]({{ site.baseurl }}/images/wheelview.gif)
