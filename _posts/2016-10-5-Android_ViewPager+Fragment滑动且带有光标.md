...
类似于TabLayout的功能，自己用代码写的一个Demo

代码地址：[https://github.com/7449/AndroidDevelop/tree/master/ViewPagerFragment](https://github.com/7449/AndroidDevelop/tree/master/ViewPagerFragment)
...
![_config.yml]({{ site.baseurl }}/images/viewpagerFragment.gif)